# Compound Process Analysis

## Project Overview
This project analyzes the compound stochastic process S(t) where:
- Interarrival times follow Exponential(λ) distribution
- Claim sizes follow Exponential(μ) distribution
- S(t) = ΣXi represents the aggregate claims up to time t
